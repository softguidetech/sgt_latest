...
class TestExam(common.TransactionCase):
    def setUp(self):
        ...
        self.hr_employee = self.env.ref("school_mngment_sgt.demo_school_teacher_2")
        self.subject_id = self.env.ref("school_mngment_sgt.demo_subject_subject_1")
        self.std = self.env.ref("school_mngment_sgt.demo_standard_standard_1")
        self.standards = self.env.ref("school_mngment_sgt.demo_school_standard_1")
        self.student = self.env.ref("school_mngment_sgt.demo_student_student_7")
        self.subject_id = self.env.ref("school_mngment_sgt.demo_subject_subject_1")
        self.year_id = self.env.ref("school_mngment_sgt.demo_academic_year_2")
        self.grade_system = self.env.ref("school_mngment_sgt.demo_student_grade_1")
        self.standard_std = self.env.ref("school_mngment_sgt.demo_standard_standard_2")
        self.school_standard = self.env.ref("school_mngment_sgt.demo_school_standard_2")
        self.student_student = self.env.ref("school_mngment_sgt.demo_student_student_5")
        self.grade_line = self.env.ref("school_mngment_sgt.demo_student_grade_line_6")
        self.room_id = self.env.ref("school_mngment_sgt.class_room14")
        # Create Exam Timetable
        self.time_table = self.time_table_obj.create(
            {
                "name": "Mid Term Exam",
        ...
        self.time_table_line = self.time_table_line_obj.create(
            {
                "exm_date": time.strftime("06-01-2017"),
        ...
        # Create Exam
        self.exam_exam = self.exam_exam_obj.create(
            {
                "exam_code": "2017/06/097",
                "name": "Mid Term Exam",
        ...
        self.exam_schedule_line = self.exam_schedule_line_obj.create(
            {
                "standard_id": self.school_standard.id,
        ...
        # Create exam result
        self.exam_result = self.exam_result_obj.create(
            {
        ...
        # Create Subject
        self.exam_subject = self.exam_subject_obj.create(
            {
                "subject_id": self.subject_id.id,
                "maximum_marks": 100,
                "minimum_marks": 35,
        ...
        self.additional_exam = self.additional_exam_obj.create(
            {
                "additional_exam_code": "2017/06/098",
        ...
        self.add_exam_result = self.additional_exam_result_obj.create(
            {
                "a_exam_id": self.additional_exam.id,
        ...
        data, data_format = self.env.ref(
            "school_mngment_sgt.additional_exam_result_id_qweb"
    ...
    def test_exam(self):
        ...
        self.assertEqual(
            self.exam_schedule_line.timetable_id.standard_id.id,
