...
class TestFees(common.TransactionCase):
    def setUp(self):
        ...
        self.student = self.env.ref("school_mngment_sgt.demo_student_student_6")
        self.school = self.env.ref("school_mngment_sgt.demo_school_1")
        self.standard = self.env.ref("school_mngment_sgt.demo_school_standard_1")
        self.product = self.env.ref("school_mngment_sgt.demo_product_fees_1")
        #       Create Payslip Line
        ...
        self.fees_structure_line = self.fees_structure_line_obj.create(
            {
        ...
        self.fees_structure = self.fees_structure_obj.create(
            {
        ...
        self.fees_register = self.fees_register_obj.create(
            {
        ...
        self.student_payslip = self.student_payslip_obj.create(
            {
