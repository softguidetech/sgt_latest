...
class TestLibrary(common.TransactionCase):
    def setUp(self):
        ...
        self.student_id = self.env.ref("school_mngment_sgt.demo_student_student_5")
        self.school_standard = self.env.ref("school_mngment_sgt.demo_school_standard_2")
        self.standard = self.env.ref("school_mngment_sgt.demo_standard_standard_2")
        self.product = self.env.ref("school_mngment_sgt.library_product_b2")
        self.res_partner = self.env.ref("base.res_partner_1")
        self.category = self.env.ref("product.product_category_1")
        self.company_id = self.env.ref("school_mngment_sgt.demo_school_1")
        self.product_book = self.env.ref("school_mngment_sgt.product_product_b1")
