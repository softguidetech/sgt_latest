...
class TestSchool(common.TransactionCase):
    def setUp(self):
        ...
        self.school_id = self.env.ref("school_mngment_sgt.demo_school_1")
        self.standard_medium = self.env.ref("school_mngment_sgt.demo_standard_medium_1")
        self.year = self.env.ref("school_mngment_sgt.demo_academic_year_2")
        self.currency_id = self.env.ref("base.INR")
        self.sch = self.env.ref("school_mngment_sgt.demo_school_1")
        ...
        self.subject1 = self.env.ref("school_mngment_sgt.demo_subject_subject_1")
        self.subject2 = self.env.ref("school_mngment_sgt.demo_subject_subject_2")
        self.student_student = self.env.ref("school_mngment_sgt.demo_student_student_2")
        self.student_done = self.env.ref("school_mngment_sgt.demo_student_student_6")
        self.parent = self.env.ref("school_mngment_sgt.demo_student_parent_1")
